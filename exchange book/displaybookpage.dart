...
class DisplayBookPage extends StatelessWidget {
  ...
  const DisplayBookPage({
    ...
    this.bookStatus, this.bookId, this.collegeId, this.departmentId, this.userId,
  });
...
print('7:51----------------------gggggggggggggggggggggg');
  print('user id from widget $userId ');
    ...
    print("now at 1:6 i am tring to find the error");
    print('Book Name: $bookName');
    print('Book Price: $bookPrice');
    print('Email: $email');
    print('Additional Details: $additionalDetails');
    print('Book Status: $bookStatus');
 print('Email: $collegeId');
    print('Additional Details: $departmentId');
    print('Book id T 1:33 dddddddddddddddddddddddddddddddddddddddddddddddddddddddd $bookId');
                    ...
                    return AlertDialog(
                      ...
                      actions: [
                        ...
                        TextButton(
                          onPressed: () async {
                            try {
                              CollectionReference bookCollection = FirebaseFirestore.instance.collection('users').doc(userId).collectionGroup('Books');
