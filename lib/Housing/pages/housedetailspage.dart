...
class DisplayHouseDetailPage extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      appBar: AppBar(
         iconTheme: IconThemeData(color: Colors.white), // Set the default color of icons and back arrow
        backgroundColor: kPrimaryColor,
        title: Text(houseDetails.houseName,style: TextStyle(color: Colors.white)),
        actions: [
          if (enabled)
            PopupMenuButton(
    ...
    MaterialPageRoute(
      builder: (context) => EditHousePage(
        ...
        houseData: {
          ...
          'numOccupants': houseDetails.occupants.toString(),
                                    ...
                                    try {
                                      ...
                                      QuerySnapshot querySnapshot = await housesCollection
                                          .where('houseName', isEqualTo: houseDetails.houseName)
                                                  .where('price', isEqualTo: houseDetails.housePrice)
                                         
                                          .where('email', isEqualTo: houseDetails.email)
          ...
          children: [
           /* Padding(
            ...
            ListTile(
              ...
              title: Text('Gender: ${houseDetails.gender}'),
            ),
            ListTile(
