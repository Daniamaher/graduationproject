                  ...
                  MaterialPageRoute(
                    builder: (context) => EditHousePage(
                      ...
                      houseData: {
                       ...
                       'additionalDetails':widget.houseDetails.additionalDetails
        ...
        child: Column(
          ...
          children: [
            ...
            ListTile(
              ...
              title: Text('Free Internet: ${widget.houseDetails.hasFreeInternet ? 'Yes' : 'No'}'),
            ),
            
             ListTile(
  leading: Icon(Icons.more, color: kPrimaryColor),
  title: Text('Additional details: ${widget.houseDetails.additionalDetails}'),
),
