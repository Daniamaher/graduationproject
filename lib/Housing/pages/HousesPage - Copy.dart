...
class _HousingPageState extends State<HousingPage> {
  ...
  int? _selectedBathroom;
    //bool isEduEmail = user?.email?.endsWith('@edu.jo') ?? false;
...
backgroundColor:Color(0xff0f1035) ,
          ...
          builder: (context, snapshot) {
            ...
            return GridView.builder(
              ...
              itemBuilder: (context, index) {
                final houseData = filteredHouseDocs[index].data() as Map<String, dynamic>;
                ...
                return HouseItem(
                  ...
                  bathrooms: houseData['numBathrooms'] ?? 0,   houseId: houseDocs[index].id,
                );
              },
            );
          },
  ...
  void _showFilterDialog() {
    ...
    ValueNotifier<String?> selectedGenderNotifier = ValueNotifier<String?>(_selectedGender);
    ValueNotifier<int?> selectedBathroomNotifier = ValueNotifier<int?>(_selectedBathroom);
...
class _HousingPageState extends State<HousingPage> {
  ...
  Widget build(BuildContext context) {
    final FirebaseFirestore firestore = FirebaseFirestore.instance;
    final user = FirebaseAuth.instance.currentUser;
    //bool isEduEmail = user?.email?.endsWith('.edu.jo') ?? false; // Corrected check
bool isEduEmail = user?.email?.toLowerCase().endsWith('@edu.jo') ?? false;
print("88888888888888888888888888888888888888888888888888888888888888888888888888888888888888888888888888888888888888888888888888888888888888888888888888888888888888888888888x");
print("isEduEmail       888888888");
