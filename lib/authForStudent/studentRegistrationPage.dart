...
import 'package:gradution_project/DropdownButton.dart';
import 'package:gradution_project/Verify.dart';
import 'package:gradution_project/constant.dart';
import 'package:gradution_project/customTextField.dart';

class StudentrRegistrationPage extends StatefulWidget {
  const StudentrRegistrationPage({Key? key}) : super(key: key);

  @override
  _StudentrRegistrationPageState createState() =>
      _StudentrRegistrationPageState();
}

class _StudentrRegistrationPageState extends State<StudentrRegistrationPage> {
