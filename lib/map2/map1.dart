...
class _MarkerMapPageState extends State<MarkerMapPage> {
      ...
      body: Stack(
        children: [
          ...
          Positioned(
            ...
            left: 10,
            right: 10,
            child: SearchBar(_addMarkerFromSearch, toggleAutoZoom),
          ),
          Positioned(
            bottom: 10,
            left: 10,
  ...
  void _addMarkerFromSearch(String location) async {
    try {
      ...
      // Check if auto-zoom is enabled and the location is a restaurant, cafe, or country
      if (_autoZoomEnabled &&
          (location.contains('restaurant') ||
              ...
              Expanded(
                child: TextField(
                  ...
                  decoration: InputDecoration(
                    hintText: 'Add Marker to location',
...
class MarkerMapPage1 extends StatefulWidget {
  final Function(LatLng) onLocationSelected;

  MarkerMapPage1({required this.onLocationSelected});

  @override
  _MarkerMapPageState createState() => _MarkerMapPageState();
}

class _MarkerMapPageState extends State<MarkerMapPage1> {
  late GoogleMapController _controller;
  LatLng jordanLocation = LatLng(31.9632, 35.9304); // Jordan's coordinates
